...
const Carousel = () => {
  return (
    <section
      id="carousel"
      className="shadow-carousel relative flex flex-col justify-start items-start mt-3 mb-24 pt-5 px-6 pb-44 w-full rounded-xl blur-none transition-all duration-500  bg-[#212629] z-[2]"
    >
      {/* <!-- text --> */}
